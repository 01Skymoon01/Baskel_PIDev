 ...
 */
public class VehiculeForm extends BaseForm{
...
public VehiculeForm() {
    ...
    public VehiculeForm(com.codename1.ui.util.Resources resourceObjectInstance) {
        initGuiBuilderComponents(resourceObjectInstance);

        getToolbar().setTitleComponent(
                FlowLayout.encloseCenterMiddle(
                        new Label("Vos Vehicules", "Title"),
                        new Label(Integer.toString(ServiceVehicule.getInstance().getAllVehicules().size()), "InboxNumber")
                )
        );
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">    
    ...
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        setTitle("VehiculeForm");
        setName("VehiculeForm");
      ...
      //  gui_Container_text.add(gui_Text_Field_1);
        ...
        for (i = 0; i < ServiceVehicule.getInstance().getAllVehicules().size(); i++) {
...
//            gui_Label_1.setText(sdf.format(ServiceVehicule.getInstance().getAllVehicules().get(i).getMatricule()));
            ...
            gui_Label_ID.setText(Integer.toString(ServiceVehicule.getInstance().getAllVehicules().get(i).getId()));
            gui_Label_3.setText("Vehicule id N°:" + ServiceVehicule.getInstance().getAllVehicules().get(i).getId());
            gui_Label_3.setName("Label_3");
            gui_Label_2.setText( ServiceVehicule.getInstance().getAllVehicules().get(i).getMatricule());
            gui_Label_2.setUIID("RedLabel");
            gui_Label_2.setName("Label_2");
            gui_Text_Area_1.setText( ServiceVehicule.getInstance().getAllVehicules().get(i).getMarque());
            gui_Label_Detail.setText (ServiceVehicule.getInstance().getAllVehicules().get(i).getType());
        ...
        Button myBtn = new Button();
             ...
             myBtn.addActionListener(new ActionListener() {
                 ...
                 */
                 ...
                 if ( Dialog.show("Completed", "Voulez-vous supprimer ou modifier la Vehicule n:"+gui_Label_ID.getText(), "Supprimer", "Modifier") ){
                   ...
                   System.out.println( gui_Label_ID);
                    System.out.println("supprimeee");
                     try {
                         if (ServiceVehicule.getInstance().SupprimerReclamationJson(r)==1) {
                     ...
                     new ModifiVehiculeForm(resourceObjectInstance, Integer.parseInt(gui_Label_ID.getText())).show();  
