...
public class UploadServices {
    public String upload(String Path) {
        ...
        try {
            //FileUploader fu = new FileUploader("localhost/WebProjectSymfony/Baskel/");
            FileUploader fu = new FileUploader("localhost/WebForumSymfony/WebProjectSymfony/Baskel/");

            //Upload
            System.out.println("Path upload :" + Path);
             fileNameInServer = fu.upload(Path);
             System.out.println("filenameinserver : " + fileNameInServer);
