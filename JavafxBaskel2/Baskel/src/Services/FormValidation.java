...
public class FormValidation {
    ...
    public static boolean textFieldNotEmpty(TextField t){
       ...
       public static boolean textFieldTypeNumber(TextField t){
           boolean test=false;
           if(t.getText().matches("[0-9]+") && (t.getText().length()==6)){
               test=true;
           }
           return test;
       }
       
        public static boolean textFieldTypeNumberCIN(TextField t){
           boolean test=false;
           if(t.getText().matches("[0-9]+") && (t.getText().length()==8)){
               test=true;
           }
           return test;
       }           
        ...
        return test;
           ...
           public static boolean textFieldTypeNumberCIN(TextField t, Label l , String sValidationText){
        boolean  test=true;
        String c =null;
        if(! textFieldTypeNumberCIN(t)){
            test=false;
            c=sValidationText;
        }
        l.setText(c);
